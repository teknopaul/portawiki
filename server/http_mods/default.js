...
/**
 * Return a 404 TODO much more funky version
 * @param response
 */
function fileNotFound(response) {
	response.writeHead(404, "NOT FOUND", {'Content-Type': 'text/html' });
	var instream = fs.createReadStream('./resources/404.html');
...
/*
mock = new Object();
mock.writeHead = function(header,value){
	console.log(header, value)
};
mimeMagic(mock, "app/file.html");
mimeMagic(mock, "app/file.css");
mimeMagic(mock, "app/file.js");
mimeMagic(mock, "app/file.png");
mimeMagic(mock, "app/file.jpeg");
mimeMagic(mock, "app/file.jpg");
mimeMagic(mock, "app/file.json");
mimeMagic(mock, "app/file");
*/